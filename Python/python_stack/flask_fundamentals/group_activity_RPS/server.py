...
def play():
	...
	if user == new_rand:
		result = "it's a tie the computer selected " + dictionary[new_rand]
		session['ties'] += 1
	elif user == "1" and new_rand == "2":
		result = "you loose the computer selected " + dictionary[new_rand]
		session['losses'] += 1
	elif user == "1" and new_rand == "3":
		result = "you win the computer selected " + dictionary[new_rand]
		session['wins'] += 1
