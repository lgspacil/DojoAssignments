...
class User(models.Model):
  ...
  objects = UserManager() # this line connects the model to the UserManger class which allows you to add model level validations
  # if you do not have any model level validations, you dont need this
...
class UserManager(models.Manager):
  def login(self, postData):
    # insert code
    return <insert something to return > # return something
